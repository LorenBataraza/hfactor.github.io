...
function changeIconImgSrc(src_value) {
	document.getElementById("theme-toggle-img").src = src_value;
	document.getElementById("theme-toggle-img--mobile").src = src_value;
}
